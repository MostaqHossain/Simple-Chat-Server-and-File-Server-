 ...
 */
public class SimpleChatView extends FrameView {

    Socket client[]=new Socket[100];// WHOLE SYSTEM CAN HOLD UPTO 100 CLIENTS
    public SimpleChatView(SingleFrameApplication app) {
        super(app);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(desktopapplication4.DesktopApplication4.class).getContext().getResourceMap(SimpleChatView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(desktopapplication4.DesktopApplication4.class).getContext().getActionMap(SimpleChatView.class, this);
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        ...
        try {
            ...
            Logger.getLogger(SimpleChatView.class.getName()).log(Level.SEVERE, null, ex);
        }
